...
P0 = 0.90;      %η = 1, 0.9, 0.95, 0.85
P1 = 0.95;      %μ = 1, 0.9, 0.95, 0.85
P2 = 0.95;      %ρ = 1, 0.9, 0.95, 0.85
...
for H = 0.1:0.1:36.0
    Num = round(H*10);
    Y_MLSFICF1(Num) = alpha_x(H);
    YY_MLSFICF1(Num) = alpha_c/(1+(H-H0)^2*g2(H0)/(g1(H0)*c));
end

figure(1);
X = 0.1:0.1:36.0;
plot(X,Y_MLSFICF1,'b+');hold on;
plot(X,YY_MLSFICF1,'r+');hold off;
